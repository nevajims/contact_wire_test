...
Settings_path    =  [getenv('APPDATA'),'\SETTINGS_FILES\Test_Settings2.mat']       ;
[Test_Settings2 , ~] =  load_mat_structure_from_file(Settings_path)                ;
...
[Options_,Defaults] = get_options_Defaults(Test_Settings2);
...
Test_Settings_updated = get_test_parameters_essential(fig,Test_Settings2);
...
function Test_Settings2 = get_test_parameters_essential(fig,Test_Settings2)
...
Test_Settings2 = update_Test_Settings2(Test_Settings2,new_vals_);
close (fig)


end %function Test_Settings2 = get_test_parameters_essential(fig)



function Test_Settings2 = update_Test_Settings2(Test_Settings2,new_vals_)

Test_Settings2.Sampling.Sample_RateHz =  new_vals_.SR_index   ;
Test_Settings2.Sampling.adc_Range_    =  new_vals_.ADC_index  ;
Test_Settings2.Toneburst.Frequency    =  new_vals_.TF_index   ;
Test_Settings2.Toneburst.num_cycles   =  new_vals_.NC_index   ;
Test_Settings2.Toneburst.Shape        =  new_vals_.TB_index   ;
Test_Settings2.Sampling.Num_Averages  =  new_vals_.NA_index   ;
Test_Settings2.Sampling.Num_Samples   =  new_vals_.NS_index   ;    

end %function Test_Settings2 = update_Test_Settings2(Test_Settings2,new_vals_);


function [Options_,Defaults] = get_options_Defaults(Test_Settings2)
dum =  Test_Settings2.Sampling;
...
%ROW 3
%----------------------------------------------------------------------------------
fig.UserData.inps.DD_7 = uidropdown(fig,"Items",[Options_.num_samples ],'Position', [x_mult*145, y_mult*135, x_mult*100, y_mult*28],'FontSize',y_mult*18,'Value',Options_.num_samples{Defaults.NS_index})   ;
lbl7 = uilabel(fig,'Position',[x_mult*145, y_mult*160, x_mult*100, y_mult*28],'Text', 'No Samples','FontSize',y_mult*18)                                           ;
