...
if isstruct(display_settings_updated)
...
fig = uifigure('Resize','off','Units','normalized','Position',[0.05,0.05,0.2*mag_fac,0.3*mag_fac],'Name', 'Display Settings');
fig.Icon = 'ICON2.png';
fig.UserData.S_button_pressed = 0;
...
[display_settings_default , ~ ]          = load_mat_structure_from_file(FD_settings_path); 
[Options_,Defaults] = get_options_Defaults(display_settings_default);
