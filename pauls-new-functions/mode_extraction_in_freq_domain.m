function out = mode_extraction_in_freq_domain(inv_mode_shapes, matrix_calc_freqs, raw_data, proc_data, apply_as_time_shift, min_time_step, allow_neg_amps, suppress_display);
tic;
