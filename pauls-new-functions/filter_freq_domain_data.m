function raw_data = filter_freq_domain_data(raw_data_in, input_signal, delay, freq_comp_for_input_signal, freq_filter_on, freq_filter, freq_filter_bandwidth, suppress_display);
tic;
