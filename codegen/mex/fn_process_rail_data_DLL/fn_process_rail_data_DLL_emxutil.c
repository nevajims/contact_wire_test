 ...
 *
 * fn_process_rail_data_DLL_emxutil.c
 *
                               ...
                               const emlrtRTEInfo *srcLocation)
{
  ...
  if (newNumel > emxArray->allocatedSize) {
    ...
    newData = emlrtMallocMex((uint32_T)newCapacity * sizeof(int64_T));
    if (newData == NULL) {
      emlrtHeapAllocationErrorR2012b(srcLocation, (emlrtCTX)sp);
    }
    if (emxArray->data != NULL) {
      memcpy(newData, emxArray->data, sizeof(int64_T) * (uint32_T)oldNumel);
      if (emxArray->canFreeData) {
        emlrtFreeMex(emxArray->data);
      }
    }
    emxArray->data = (int64_T *)newData;
    emxArray->allocatedSize = newCapacity;
    emxArray->canFreeData = true;
  }
}
                     ...
                     int32_T numDimensions, const emlrtRTEInfo *srcLocation)
{
  ...
  int32_T i;
  *pEmxArray =
      (emxArray_int64_T *)emlrtMallocEmxArray(sizeof(emxArray_int64_T));
  if ((void *)*pEmxArray == NULL) {
    emlrtHeapAllocationErrorR2012b(srcLocation, (emlrtCTX)sp);
  }
  emlrtPushHeapReferenceStackEmxArray((emlrtCTX)sp, true, (void *)pEmxArray,
                                      (void *)&emxFree_int64_T, NULL, NULL,
                                      NULL);
  emxArray = *pEmxArray;
...
/* End of code generation (fn_process_rail_data_DLL_emxutil.c) */
